...
const days: Day[] = [
  ...
  },
  {
    ...
    transport: "地鐵 S1 號線＋公車／計程車＋景區接駁車＋地鐵 3 號線＋步行＋秦淮河畫舫", hotel: "南京南站清木尚酒店",
    note: "牛首山建議提前 1–7 天透過「牛首山文化旅遊區」官方微信或旅遊平台實名購票，並購買景區觀光車票（參考價約人民幣 10 元／次或 20 元全天）。夫子廟步行街免費，江南貢院／中國科舉博物館與大成殿須另行購票；特殊管制期間可能需預約入街。秦淮河夜間畫舫建議提前線上預約或抵達後儘早換票候船，實際票價與規則以官方公告為準。",
    stops: [
      { time: "08:30–09:30", title: "南京南站前往牛首山", detail: "搭地鐵 S1 號線至河海大學·佛城西路站 2 號口，轉乘 754 路／G70 路公車至牛首山風景區東站；也可出站後打車約 10 分鐘。全程約 14 公里，交通與步行合計約 40–50 分鐘。" },
      { time: "09:30–13:00", title: "牛首山文化旅遊區", detail: "由東門入園，搭景區接駁車直達天闕站。重點參觀佛頂宮水景廣場、禪境大觀、地下萬佛廊，再依時間前往佛頂塔與佛頂寺，預留約 3.5 小時。" },
      { time: "13:00–14:30", title: "午餐與前往夫子廟", detail: "搭接駁車返回東門，可搭 754 路公車回河海大學·佛城西路站，轉 S1 號線至南京南站，再轉地鐵 3 號線至夫子廟站 2／3 號口；全程約 55–65 分鐘。", food: "園內可選梁武素食（佛頂宮 B1）；東門商業街可選一葉一世界素食藏茶火鍋，或肯德基、連鎖麵館與茶飲快速用餐。" },
      { time: "14:30–18:00", title: "夫子廟核心街區", detail: "由地鐵站步行約 5–8 分鐘進入貢院街，漫步夫子廟核心步行街，依興趣參觀江南貢院／中國科舉博物館與大成殿，預留約 3.5 小時。" },
      { time: "18:00–19:30", title: "秦淮河畔晚餐", detail: "在夫子廟與秦淮河畔享用金陵特色晚餐，餐後散步欣賞亮燈夜景。", food: "南京大牌檔（夫子廟平江府店）：鹽水鴨、美齡粥、王府泡椒雞、古法糖芋苗；奇芳閣：鴨油酥燒餅、什錦素菜包、牛肉鍋貼；也可步行約 10 分鐘至老門東蔣有記品嚐牛肉鍋貼與牛肉餛飩。" },
      { time: "19:30–21:00", title: "秦淮河夜間畫舫", detail: "從夫子廟大成殿步行約 3–5 分鐘至泮池碼頭，搭乘內秦淮東線夜間畫舫；航程約 40–50 分鐘，預留排隊候船時間。結束後搭地鐵返回南京南站。" },
    ],
  },
  {
    date: "11/22", weekday: "日", label: "DAY 5", title: "名山秋色與湖光城牆",
    transport: "地鐵 3／4 號線＋206 路／D21 路公車＋計程車＋景區觀光車＋步行", hotel: "南京南站清木尚酒店",
    note: "棲霞山參考門票約人民幣 50 元，紅楓節期間可能調整至約 80 元，可透過「南京棲霞山」官方微信、美團或現場購票；省力遊覽請購買單程上山觀光車票（參考價約 10–20 元）。雞鳴寺香花券約 10 元、明城牆台城段約 30 元，皆可現場或線上購票；玄武湖免費、免預約。請攜帶台胞證並穿防滑好走的鞋，實際票價與班次以官方公告為準。",
    stops: [
      { time: "08:30–10:00", title: "南京南站前往棲霞山", detail: "搭地鐵 3 號線至新莊站 2 號口，轉乘 206 路／D21 路公車至棲霞寺站；約 33 公里、總交通約 1 小時 20 分鐘，下車步行約 5 分鐘抵達西門。若攜帶行李，先至西門遊客服務中心詢問寄存。" },
      { time: "10:00–10:20", title: "明鏡湖與九曲橋", detail: "從西門沿平坦步道前往明鏡湖，欣賞湖心彩虹亭、九曲橋與湖面倒影，先拍攝棲霞山經典景觀。" },
      { time: "10:20–11:05", title: "棲霞古寺・舍利塔・千佛岩", detail: "沿主道步行約 5 分鐘進入千年古剎，參觀秋季銀杏紅楓；再至大雄寶殿後方欣賞隋代五層八面舍利塔，以及有「江南小雲岡」之稱的南朝千佛岩。此區有部分石階。" },
      { time: "11:05–11:20", title: "觀光車直上山頂", detail: "返回寺廟旁觀光車乘車點，購買單程上山車票，約 10–15 分鐘直達鳳翔峰／始皇臨江處站，略過最耗體力的陡坡。" },
      { time: "11:20–11:40", title: "始皇臨江處", detail: "在山頂觀景平台遠眺長江、棲霞長江大橋與秋季彩林，停留約 20 分鐘。" },
      { time: "11:40–12:30", title: "紅葉谷・楓林湖・桃花湖", detail: "由山頂沿緩坡柏油步道下山，途經紅葉谷、楓林湖與桃花湖；全程以下坡或平路為主。若腿腳疲累，可在山腰站點再搭觀光車返回西門。" },
      { time: "12:30–13:30", title: "棲霞山午餐", detail: "在景區或棲霞老街快速用餐，休息後準備返回市區。", food: "棲霞寺素麵館：香菇麵、羅漢上素麵；棲霞老街周邊可選江蘇家常菜、鹽水鴨或鴨血粉絲湯。" },
      { time: "13:30–14:45", title: "前往雞鳴寺", detail: "省時省力首選：由西門打車直達雞鳴寺路口／雞鳴寺站 5 號口，約 26 公里、35–45 分鐘，參考車資約人民幣 60–80 元。預算優先可搭 206 路至聚寶山站轉地鐵 4 號線直達雞鳴寺站，或至新莊站轉 3 號線；約 75–90 分鐘。" },
      { time: "14:45–15:45", title: "古雞鳴寺", detail: "參拜千年古剎、參觀藥師佛塔並俯瞰城景；從後門出口步行約 2 分鐘即可銜接明城牆台城售票處。" },
      { time: "15:45–17:00", title: "明城牆台城段", detail: "沿城牆往解放門方向步行約 10–15 分鐘，登高俯瞰玄武湖與紫金山，預留 1–1.5 小時感受古城風貌。" },
      { time: "17:00–18:30", title: "玄武湖公園", detail: "由解放門下城牆後直接入園，漫步菱洲／梁洲與湖畔步道，欣賞夕陽湖景。" },
      { time: "18:30–20:30", title: "玄武門／新街口晚餐", detail: "由玄武門出園，可前往湖南路獅子橋，或搭地鐵 1 號線前往鼓樓／新街口用餐，餐後散步返程。", food: "南京大牌檔（獅子橋店或德基廣場店）：金陵烤鴨、美齡粥、江米扣肉；玄武門周邊亦可選清真·馬祥興菜館的蛋燒賣、松鼠鱖魚，或小廚娘淮揚菜。" },
    ],
  },
  {
